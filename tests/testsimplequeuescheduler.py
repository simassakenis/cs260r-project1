...
class TestSimpleQueueScheduler(unittest.TestCase):
    ...
    def test_simple_queue_scheduler_1(self):
        '''
            Function to test simple queue scheduler with 1 map node and 1 reduce node
        '''
    ...
    def test_simple_queue_scheduler_2(self):
        '''
            Function to test simple queue scheduler with 1 map nodes and 1 reduce node
        '''
        # initializing Computation Graph
        num_map_nodes = 1
        num_reduce_nodes = 1
        ...
        self.assertEqual(scheduled_pairs[0][0].node_id, 0)
        self.assertEqual(scheduled_pairs[0][1].node_id, 0)
        self.assertEqual(scheduled_pairs[1][0].node_id, 1)
        self.assertEqual(scheduled_pairs[1][1].node_id, 1)
